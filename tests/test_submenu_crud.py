...
#     response = client.post(f'{prefix}/menus/',
#                            json=menu_data)
...
#     response = client.post(f'{prefix}/menus/{menu_id}/submenus/',
#                            json=submenu_data)
#     assert response.status_code == 201
...
#             f"{prefix}/menus/{menu_id}/submenus/{submenu['id']}")
...
#             f'{prefix}/menus/{menu_id}/submenus/', json=update_submenu_data
#         )
#         assert response.status_code == 201
#         assert 'id' in response.json()

#     response = client.get(
#         f'{prefix}/menus/{menu_id}/submenus/')
#     assert response.status_code == 200
#     submenu_list = response.json()
#     assert isinstance(submenu_list, list)

#     titles = [menu['title'] for menu in submenu_list]

#     expected_titles = [
#         update_submenu_data['title']
#         for update_submenu_data in update_submenu_datas
#     ]
